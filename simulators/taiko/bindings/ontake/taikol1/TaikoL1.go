...
// GetTransitionById is a free data retrieval call binding the contract method 0x947544a4.
//
// Solidity: function getTransitionById(uint64 _blockId, bytes32 _blockHash) view returns(uint24)
func (_TaikoL1 *TaikoL1Caller) GetTransitionById(opts *bind.CallOpts, _blockId uint64, _blockHash [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _TaikoL1.contract.Call(opts, &out, "getTransitionById", _blockId, _blockHash)
...
//
// Solidity: function getTransitionById(uint64 _blockId, bytes32 _blockHash) view returns(uint24)
func (_TaikoL1 *TaikoL1Session) GetTransitionById(_blockId uint64, _blockHash [32]byte) (*big.Int, error) {
	return _TaikoL1.Contract.GetTransitionById(&_TaikoL1.CallOpts, _blockId, _blockHash)
}

// GetTransitionById is a free data retrieval call binding the contract method 0x947544a4.
//
// Solidity: function getTransitionById(uint64 _blockId, bytes32 _blockHash) view returns(uint24)
func (_TaikoL1 *TaikoL1CallerSession) GetTransitionById(_blockId uint64, _blockHash [32]byte) (*big.Int, error) {
	return _TaikoL1.Contract.GetTransitionById(&_TaikoL1.CallOpts, _blockId, _blockHash)
}
...
func (_TaikoL1 *TaikoL1Transactor) InitL2Genesis(opts *bind.TransactOpts, _genesisBlockHash [32]byte) (*types.Transaction, error) {
	return _TaikoL1.contract.Transact(opts, "initL2Genesis", _genesisBlockHash)
}

// InitL2Genesis is a paid mutator transaction binding the contract method 0xd92becee.
//
// Solidity: function initL2Genesis(bytes32 _genesisBlockHash) returns()
func (_TaikoL1 *TaikoL1Session) InitL2Genesis(_genesisBlockHash [32]byte) (*types.Transaction, error) {
	return _TaikoL1.Contract.InitL2Genesis(&_TaikoL1.TransactOpts, _genesisBlockHash)
}

// InitL2Genesis is a paid mutator transaction binding the contract method 0xd92becee.
//
// Solidity: function initL2Genesis(bytes32 _genesisBlockHash) returns()
func (_TaikoL1 *TaikoL1TransactorSession) InitL2Genesis(_genesisBlockHash [32]byte) (*types.Transaction, error) {
	return _TaikoL1.Contract.InitL2Genesis(&_TaikoL1.TransactOpts, _genesisBlockHash)
}
