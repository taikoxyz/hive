...
func (_TaikoL1 *TaikoL1Transactor) ProveBlocks(opts *bind.TransactOpts, _blockIds []uint64, _inputArr [][]byte) (*types.Transaction, error) {
	return _TaikoL1.contract.Transact(opts, "proveBlocks", _blockIds, _inputArr)
}

// ProveBlocks is a paid mutator transaction binding the contract method 0x204808f6.
//
// Solidity: function proveBlocks(uint64[] _blockIds, bytes[] _inputArr) returns()
func (_TaikoL1 *TaikoL1Session) ProveBlocks(_blockIds []uint64, _inputArr [][]byte) (*types.Transaction, error) {
	return _TaikoL1.Contract.ProveBlocks(&_TaikoL1.TransactOpts, _blockIds, _inputArr)
}

// ProveBlocks is a paid mutator transaction binding the contract method 0x204808f6.
//
// Solidity: function proveBlocks(uint64[] _blockIds, bytes[] _inputArr) returns()
func (_TaikoL1 *TaikoL1TransactorSession) ProveBlocks(_blockIds []uint64, _inputArr [][]byte) (*types.Transaction, error) {
	return _TaikoL1.Contract.ProveBlocks(&_TaikoL1.TransactOpts, _blockIds, _inputArr)
}
