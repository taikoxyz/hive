...
// GetTransitionId is a free data retrieval call binding the contract method 0xefc9feed.
//
// Solidity: function getTransitionId() view returns(uint64)
func (_TaikoL1 *TaikoL1Caller) GetTransitionId(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _TaikoL1.contract.Call(opts, &out, "getTransitionId")
...
//
// Solidity: function getTransitionId() view returns(uint64)
func (_TaikoL1 *TaikoL1Session) GetTransitionId() (uint64, error) {
	return _TaikoL1.Contract.GetTransitionId(&_TaikoL1.CallOpts)
}

// GetTransitionId is a free data retrieval call binding the contract method 0xefc9feed.
//
// Solidity: function getTransitionId() view returns(uint64)
func (_TaikoL1 *TaikoL1CallerSession) GetTransitionId() (uint64, error) {
	return _TaikoL1.Contract.GetTransitionId(&_TaikoL1.CallOpts)
}
