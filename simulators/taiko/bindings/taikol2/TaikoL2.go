...
func (_TaikoL2 *TaikoL2Caller) CalculateBaseFee(opts *bind.CallOpts, _gasIssuancePerSecond uint32, _blocktime uint64, _adjustmentQuotient uint8, _parentGasExcess uint64, _parentGasUsed uint32) (struct {
	Basefee         *big.Int
	ParentGasExcess uint64
}, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "calculateBaseFee", _gasIssuancePerSecond, _blocktime, _adjustmentQuotient, _parentGasExcess, _parentGasUsed)
...
//
// Solidity: function calculateBaseFee(uint32 _gasIssuancePerSecond, uint64 _blocktime, uint8 _adjustmentQuotient, uint64 _parentGasExcess, uint32 _parentGasUsed) pure returns(uint256 basefee_, uint64 parentGasExcess_)
func (_TaikoL2 *TaikoL2Session) CalculateBaseFee(_gasIssuancePerSecond uint32, _blocktime uint64, _adjustmentQuotient uint8, _parentGasExcess uint64, _parentGasUsed uint32) (struct {
	Basefee         *big.Int
	ParentGasExcess uint64
}, error) {
	return _TaikoL2.Contract.CalculateBaseFee(&_TaikoL2.CallOpts, _gasIssuancePerSecond, _blocktime, _adjustmentQuotient, _parentGasExcess, _parentGasUsed)
}

// CalculateBaseFee is a free data retrieval call binding the contract method 0x569b3640.
//
// Solidity: function calculateBaseFee(uint32 _gasIssuancePerSecond, uint64 _blocktime, uint8 _adjustmentQuotient, uint64 _parentGasExcess, uint32 _parentGasUsed) pure returns(uint256 basefee_, uint64 parentGasExcess_)
func (_TaikoL2 *TaikoL2CallerSession) CalculateBaseFee(_gasIssuancePerSecond uint32, _blocktime uint64, _adjustmentQuotient uint8, _parentGasExcess uint64, _parentGasUsed uint32) (struct {
	Basefee         *big.Int
	ParentGasExcess uint64
}, error) {
	return _TaikoL2.Contract.CalculateBaseFee(&_TaikoL2.CallOpts, _gasIssuancePerSecond, _blocktime, _adjustmentQuotient, _parentGasExcess, _parentGasUsed)
...
func (_TaikoL2 *TaikoL2Transactor) AnchorV2(opts *bind.TransactOpts, _anchorBlockId uint64, _anchorStateRoot [32]byte, _parentGasUsed uint32, _gasIssuancePerSecond uint32, _basefeeAdjustmentQuotient uint8) (*types.Transaction, error) {
	return _TaikoL2.contract.Transact(opts, "anchorV2", _anchorBlockId, _anchorStateRoot, _parentGasUsed, _gasIssuancePerSecond, _basefeeAdjustmentQuotient)
}

// AnchorV2 is a paid mutator transaction binding the contract method 0x6a8f0462.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint32 _parentGasUsed, uint32 _gasIssuancePerSecond, uint8 _basefeeAdjustmentQuotient) returns()
func (_TaikoL2 *TaikoL2Session) AnchorV2(_anchorBlockId uint64, _anchorStateRoot [32]byte, _parentGasUsed uint32, _gasIssuancePerSecond uint32, _basefeeAdjustmentQuotient uint8) (*types.Transaction, error) {
	return _TaikoL2.Contract.AnchorV2(&_TaikoL2.TransactOpts, _anchorBlockId, _anchorStateRoot, _parentGasUsed, _gasIssuancePerSecond, _basefeeAdjustmentQuotient)
}

// AnchorV2 is a paid mutator transaction binding the contract method 0x6a8f0462.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint32 _parentGasUsed, uint32 _gasIssuancePerSecond, uint8 _basefeeAdjustmentQuotient) returns()
func (_TaikoL2 *TaikoL2TransactorSession) AnchorV2(_anchorBlockId uint64, _anchorStateRoot [32]byte, _parentGasUsed uint32, _gasIssuancePerSecond uint32, _basefeeAdjustmentQuotient uint8) (*types.Transaction, error) {
	return _TaikoL2.Contract.AnchorV2(&_TaikoL2.TransactOpts, _anchorBlockId, _anchorStateRoot, _parentGasUsed, _gasIssuancePerSecond, _basefeeAdjustmentQuotient)
}
...
func (_TaikoL2 *TaikoL2Transactor) Init2(opts *bind.TransactOpts, _initialGasExcess uint64) (*types.Transaction, error) {
	return _TaikoL2.contract.Transact(opts, "init2", _initialGasExcess)
}

// Init2 is a paid mutator transaction binding the contract method 0x19d15976.
//
// Solidity: function init2(uint64 _initialGasExcess) returns()
func (_TaikoL2 *TaikoL2Session) Init2(_initialGasExcess uint64) (*types.Transaction, error) {
	return _TaikoL2.Contract.Init2(&_TaikoL2.TransactOpts, _initialGasExcess)
}

// Init2 is a paid mutator transaction binding the contract method 0x19d15976.
//
// Solidity: function init2(uint64 _initialGasExcess) returns()
func (_TaikoL2 *TaikoL2TransactorSession) Init2(_initialGasExcess uint64) (*types.Transaction, error) {
	return _TaikoL2.Contract.Init2(&_TaikoL2.TransactOpts, _initialGasExcess)
}
