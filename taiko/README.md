...
```shell
docker build --no-cache -t hive/clients/taiko/geth:latest ./clients/taiko/geth
```

* start geth

```shell
docker run --rm --network taiko_test -it -p 8545:8545 -p 8546:8546 -p 3500:3500 hive/clients/taiko/geth:latest
```
